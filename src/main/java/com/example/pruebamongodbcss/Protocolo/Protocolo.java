...
public interface Protocolo {
    ...
    static final int OBTENER_TODOS_PROPIETARIOS=1046;
    static final int OBTENER_TODOS_PROPIETARIOS_RESPONSE=1047;
    static final int ERROROBTENER_TODOS_PROPIETARIOS=1048;

    static final int BUSCAR_DIAGNOSTICOS_POR_FECHA=1049;
    static final int BUSCAR_DIAGNOSTICOS_POR_FECHA_RESPONSE=1050;
    static final int ERRORBUSCAR_DIAGNOSTICOS_POR_FECHA=1051;

    static final int BUSCAR_PACIENTES_POR_NOMBRE=1052;
    static final int BUSCAR_PACIENTES_POR_NOMBRE_RESPONSE=1053;
    static final int ERRORBUSCAR_PACIENTES_POR_NOMBRE=1054;
